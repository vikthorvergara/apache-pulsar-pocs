...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" goto wrapper_error
...
:wrapper_error
echo Error: Unable to find maven-wrapper.jar. Downloading...
...
echo Downloaded maven-wrapper.jar successfully.
goto init
